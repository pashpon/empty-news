...
public class set extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 查找id为account的控件
        View unialButton = findViewById(R.id.unial);

        // 设置点击事件
        if (unialButton != null) {
            unialButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    // 跳转到 AccountActivity
                    Intent intent = new Intent(set.this,unial.class);
        ...
        // 查找id为account的控件
        View futureButton = findViewById(R.id.future);
        ...
        if (futureButton != null) {
            futureButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // 跳转到 AccountActivity
                    Intent intent = new Intent(set.this,future.class);
                    startActivity(intent);
                }
            });
        } else {
