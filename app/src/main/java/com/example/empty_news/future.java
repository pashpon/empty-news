...
import com.example.empty_news.club.club;
...
public class future extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (videoButton != null) {
            videoButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // 跳转到 AccountActivity
                    Intent intent = new Intent(future.this,video.class);
        ...
        // 查找id为account的控件
        View clubButton = findViewById(R.id.club);
        ...
        if (clubButton != null) {
            clubButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // 跳转到 AccountActivity
                    Intent intent = new Intent(future.this, club.class);
                    startActivity(intent);
                }
            });
        } else {
