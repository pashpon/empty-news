...
public class down extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 正确获取控件并设置点击事件
        View otherdownButton = findViewById(R.id.otherdown);

        // 确保视图已经正确加载
        if (otherdownButton != null) {
            // 设置点击事件
            otherdownButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    // 跳转到 otherdown Activity
                    Intent intent = new Intent(down.this, otherdown.class);
